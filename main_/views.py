...
from main_.models import Category, Post, Comment, Favorites
from main_.permissions import IsAuthor
from main_.serializers import CategorySerializer, PostSerializer, PostListSerializer, CommentSerializer
...
class CommentViewSet(CreateModelMixin,
    ...
    def get_permissions(self):
        # создавать коммент может залогиненный пользователь
